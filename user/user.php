...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($results) > 0){
      ...
      header('location:whatconcern.php');
   }else{
...
<body>
        <form action="" method="post" class="btnhome">
            ...
            <div style="margin-left: 30%;"> <input type="submit" value="LOGIN" name="submit"><a id="signin" href="signin.php">SIGN-IN</a><a id="back" href="../index.php">BACK</a></div>
        </form>      
</body>
</html>