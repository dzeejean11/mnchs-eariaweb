...
$select_ass = "SELECT * FROM `assignment` WHERE id='$assid'";
...
<body>
    ...
    <div class="box1">
        <form action="" method="post" class="form1">
            ...
            <div id="t3"><label>DATE FINISHED:<?php echo $row22['datefinished'];?></label></div>
            <div id="t3"><label>TIME FINISHED:<?php echo $row22['timefinished'];?></label></div>
            <img id="prof" src="../../images/<?php echo $row21['img']?>">
            <label id="lbl1">DETAILS:</label>
            <div id="details"><?php echo $row23['details'];?></div>
            <div id="buttons"><input type="submit" value="BACK" name="submit" id="sendu"></div>
        </form>
    </div>
</body>
</html>