            ...
            while($row23=mysqli_fetch_array($results2))
				{
                    ?>
            <tr>
                <td><a href="./resourcesuti.php?cid=<?php echo $cid?>&uid=<?php echo $uid?>&utid=<?php echo $row23['id']?>"><img id="prof1" src="../../images/<?php echo $row23['img']?>"/><?php echo $row23['ln'],", ",$row23['fn']," ",$row23['mn'];?></a></td>
            </tr>
            <?php
                }?>
        </table>
