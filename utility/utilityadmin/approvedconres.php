...
$select_concern = "SELECT * FROM `concerns` WHERE status1='Approved' AND concerntype='Resources'";
    ...
    <div class="box1">
        <table class="table">
            <tr>
                ...
                <th style="background-color:#6e7990;"><a href="./approvedconres.php">RESOURCES</a></th>
              ...
              while($row4=mysqli_fetch_array($results1))
				{
                    ...
                    ?>
            <tr>
                <td colspan="3"><a href="./resources.php?cid=<?php echo $row4['id']?>&uid=<?php echo $row21['id']?>"><img id="prof" src="../../images/<?php echo $row21['img']?>"/><?php echo $row21['ln'],", ",$row21['fn']," ",$row21['mn']," - ",$row4['date']," - ",$row4['time'];?></a></td>
            </tr>
            <?php
                }?>
        </table> 
