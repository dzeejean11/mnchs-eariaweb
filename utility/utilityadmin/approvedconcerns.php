...
$select_concern = "SELECT * FROM `concerns` WHERE status1='Approved' AND concerntype='Maintenance'";
...
<body>
    ...
    <div class="box1">
        <table class="table">
            <tr>
                <th style="border-top-left-radius:30px;background-color:#6e7990;"><a href="./approvedconcerns.php">MAINTENANCE</a></th>
                <th><a href="./approvedconres.php">RESOURCES</a></th>
                <th style="border-top-right-radius:30px;"><a href="./approvedconother.php">OTHER CONCERNS</a></th>
            </tr>
            <?php
              while($row4=mysqli_fetch_array($results1))
				{
                    ...
                    ?>
            <tr>
                <td colspan="3"><a href="./maintenance.php?cid=<?php echo $row4['id']?>&uid=<?php echo $row21['id']?>"><img id="prof" src="../../images/<?php echo $row21['img']?>"/><?php echo $row21['ln'],", ",$row21['fn']," ",$row21['mn']," - ",$row4['date']," - ",$row4['time'];?></a></td>
            </tr>
            <?php
                }?>
        </table>
