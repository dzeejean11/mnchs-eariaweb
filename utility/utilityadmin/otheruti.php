...
<body>
    ...
    <div class="box2">
        <form action="" method="post" class="form1">
            ...
            <div id="buttons1"><a id="back" href="./otherconcern.php?cid=<?php echo $cid?>&uid=<?php echo $uid?>&utid=<?php echo $utid?>">BACK</a><input type="submit" value="ASSIGN" name="approve" id="sendu"></div>
        </form>
    </div>
</body>
</html>