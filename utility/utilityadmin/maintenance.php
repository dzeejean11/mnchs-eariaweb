...
<body>
    ...
    <div class="box1">
        <form action="admin.php" method="post" class="form1">
            ...
            <div id="buttons"><a id="back" href="./approvedconcerns.php">BACK</a></div>
        </form>
    </div>
    <div class="box2">
        <table class="table">
            ...
            <?php
            while($row23=mysqli_fetch_array($results2))
				{
                    ?>
            <tr>
                <td><a href="./maintenanceuti.php?cid=<?php echo $cid?>&uid=<?php echo $uid?>&utid=<?php echo $row23['id']?>"><img id="prof1" src="../../UI/profile1.png"/><?php echo $row23['ln'],", ",$row23['fn']," ",$row23['mn'], " - ",$row23['expertise'];?></a></td>
            </tr>
            <?php
                }?>
        </table>
