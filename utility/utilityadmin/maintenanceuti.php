...
if(isset($_POST['approve'])){
    ...
    $query = "INSERT INTO assignment (`cid`, `utilityid`,`datearrival`,`status1`,`datefinished`,`timefinished`) VALUES('$cid', '$utid','$datearr','Assigned','','')";
...
<body>
    ...
    <div class="box2">
        <form action="" method="post" class="form1">
            ...
            <div id="buttons1"><a id="back" href="./maintenance.php?cid=<?php echo $cid?>&uid=<?php echo $uid?>&utid=<?php echo $row23['id']?>">BACK</a><input type="submit" value="ASSIGN" name="approve" id="sendu"></div>
        </form>
    </div>
</body>
</html>