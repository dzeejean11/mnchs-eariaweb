...
<body>
    ...
    <div class="box1">
        <form action="" method="post" class="form1">
            ...
            <div id="buttons"><a id="back" href="./concernsother.php">BACK</a><input type="submit" value="DECLINE" name="decline" id="decline"><input type="submit" value="APPROVE" name="approve" id="sendu"></div>
        </form>
    </div>
</body>
</html>