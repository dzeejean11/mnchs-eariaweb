...
if(isset($_POST['submit'])){
    ...
    $query = "INSERT INTO users (`emp_id`, `fn`, `mn`, `ln`, `pass`, `cpno`, `room`, `bldg`, `pos`,`utype`,`expertise`,`img`) 
  			  VALUES('$empid', '$fn', '$mn','$ln', '$pass', '$cp', '$room', '$bldg', '$pos', '$utype','$exp','$name')";
...
<body>
    ...
    <div class="box1">
        <form action="" method="post" class="form1" enctype="multipart/form-data">
            ...
            <div id="t10"><label>EXPERTISE:</label><input name="exp" type="text" id="exp"></div>
            ...
            <div id="buttons"><button id="decline"><a id="can" href="./users.php">CANCEL</a></button><input type="submit" value="SIGN-IN" name="submit" id="sendu"></div>
        </form>
    </div>
</body>
</html>
