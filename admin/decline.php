...
if(isset($_POST['decline'])){
    ...
    $query = "UPDATE concerns SET `u_id`='$uid',`details`='$det',`status1`='Declined',`files`='$file',`concerntype`='$ctype',`date`='$date',`time`='$time',`estimatedatetime`='$est' WHERE id='$cid'";
    mysqli_query($conn, $query);
    header('location:response2?cid='.$cid.'&uid='.$uid);
}
